...
},{"runeterra":7}],2:[function(require,module,exports){
class Base32 {
...
},{"./Faction":5}],4:[function(require,module,exports){
...
},{"./Base32":2,"./Card":3,"./Faction":5,"./VarInt":6}],5:[function(require,module,exports){
class Faction {
  constructor (code, id) {
    this.shortCode = code
    this.id = id
...
},{"./Card":3,"./DeckEncoder":4,"./Faction":5}]},{},[1]);
